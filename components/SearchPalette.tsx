    ...
    export default function SearchPalette() {
        ...
        const handleJump = (slide: SlideIndex, newTab = false) => {
            ...
            // 第二次點擊同一張投影片
            if (lastJumpedId === slide.id && isFocused) {
                    ...
                    {results.map((slide, index) => (
                        ...
                        >
                            <div className="flex items-center gap-2 justify-between mb-1.5">
                                ...
                                <span className={`text-[10px] font-mono ${(lastJumpedId && lastJumpedId.includes(slide.id)) ? "text-gray-500 bg-purple-100" : "text-gray-400 bg-gray-100"} px-1.5 py-0.5 rounded shrink-0`}>
                                    {slide.h}-{slide.v}
                                </span>
                            </div>
